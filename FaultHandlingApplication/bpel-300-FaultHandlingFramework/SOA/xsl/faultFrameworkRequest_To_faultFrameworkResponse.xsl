...
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsi xsl cb1 tns xsd wsdl xpath20 bpws mhdr oraext dvm hwf med ids xdk xref ora socket ldap"
    ...
    <oracle-xsl-mapper:schema>
        ...
        <oracle-xsl-mapper:mapTargets>
            <oracle-xsl-mapper:target type="WSDL">
                <oracle-xsl-mapper:schema location="../RouteToFeatureMediator.wsdl"/>
                <oracle-xsl-mapper:rootElement name="faultFrameworkResponse"
                                               namespace="http://www.oracle.com/bpel/samples"/>
