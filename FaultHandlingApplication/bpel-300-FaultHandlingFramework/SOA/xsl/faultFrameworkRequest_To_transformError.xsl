...
<xsl:stylesheet version="1.0"
                ...
                xmlns:med="http://schemas.oracle.com/mediator/xpath" xmlns:cb1="http://www.oracle.com/bpel/samples"
                ...
                exclude-result-prefixes="xsi xsl cb1 tns xsd wsdl client ns1 plnk ns2 xpath20 bpws mhdr oraext dvm hwf med ids xdk xref ora socket ldap"
    ...
    <oracle-xsl-mapper:schema>
        ...
        <oracle-xsl-mapper:mapSources>
            <oracle-xsl-mapper:source type="WSDL">
                ...
                <oracle-xsl-mapper:rootElement name="faultFrameworkRequest"
                                               namespace="http://www.oracle.com/bpel/samples"/>
            </oracle-xsl-mapper:source>
        </oracle-xsl-mapper:mapSources>
        <oracle-xsl-mapper:mapTargets>
            <oracle-xsl-mapper:target type="WSDL">
                <oracle-xsl-mapper:schema location="../FaultGeneratorBPELProcess.wsdl"/>
                <oracle-xsl-mapper:rootElement name="sampleRequest"
                                               namespace="http://xmlns.oracle.com/FaultHandlingFrameworkSample"/>
